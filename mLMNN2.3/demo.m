...
clc;
rand('seed',1);
setpaths % sets paths to c files and other helper files
%fprintf('Loading data ...\n'); % loads the default compressed usps data
% load('data/digits.mat');       

%check only 10 testing data
fprintf('Testing only with the following testing data and labels respectively');
xTe = xTe(:, 1:10);
yTe = yTe(:, 1:10)
...
[Ldim,Det]=lmnn2(xTr,yTr,1,'outdim',50,'quiet',1,'maxiter',500,'validation',0.3,'checkup',0);
